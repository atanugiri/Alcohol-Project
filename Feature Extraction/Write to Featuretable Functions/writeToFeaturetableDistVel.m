...
for i = 1:length(idList)
    try
        ...
        updateQuery = sprintf("UPDATE %s SET distance_until_limiting_time_stamp_method2=%s, " + ...
            "velocity_until_limiting_time_stamp_method2=%s WHERE id=%d", tableName, distanceUntilLimitingTimeStamp, ...
