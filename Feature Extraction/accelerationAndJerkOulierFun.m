...
try
    ...
    X = X(1:limitingTimeIndex);
    Y = Y(1:limitingTimeIndex);
    t = t(1:limitingTimeIndex);
    ...
    accOutlierMoveMedian = sum(isoutlier(A,"movmedian",5))/subject_data.distance_until_limiting_time_stamp;
