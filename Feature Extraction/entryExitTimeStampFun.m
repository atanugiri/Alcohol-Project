...
function [entryTime,exitTime,logicalApproach,distanceBeforeTone, ...
...
try
    ...
    t = cleanedDataWithTone.t(cleanedDataWithTone.t >= startingCoordinatetimes);
    ...
    distanceAfterToneUntilEntryTimeStamp = [];
    velocityAfterToneUntilEntryTimeStamp = [];
    distanceAfterEntryTimeStampUntilLimitingTimeStamp = [];
    velocityAfterEntryTimeStampUntilLimitingTimeStamp = [];
    distanceAfterExitTimeStamp = [];
    velocityAfterExitTimeStamp = [];
    distanceAfterExitTimeStampUntilLimitingTimeStamp = [];
    velocityAfterExitTimeStampUntilLimitingTimeStamp = [];
end
